...
//BuscaPublicacoes traz as publicações que apareceriam no feed do usuário
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao é possivel atualizar uma publicaçao que nao seja sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao é possivel deletar uma publicaçao que nao seja sua"))
		return
	}
